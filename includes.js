...
//print greetings
$("#Terminal").append('<div id="welcome">👋 Hi, my name is Dragan Đikandić.</div><br/><br/> I&apos;m a virtualization architect, <a href="https://www.linkedin.com/in/stefan-pejcic/" target="_blank">medior DevOps engineer</a>, and  <a href="https://profiles.wordpress.org/stefanpejcic/#content-plugins" target="_blank">WordPress plugin developer.</a><br/><br/>'); 
...
function ExecuteLine(command) {
  ...
  if (username === '') {
    ...
    //help	   
      ...
      $("#Terminal").append('help &nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Display current date and time<br/>');
...
//whoami
    ...
    $("#Terminal").empty();
    $("#Terminal").append('<img src="https://cdn.freebiesupply.com/images/large/2x/linux-logo-png-transparent.png" id="dragan" style="float: left;width: 10%; padding-right: 10px;"/></br>Dragan Đikandić – Linux sistem administrator i osnivač hosting kompanije Stellar Technologies. Radim na razvoju stabilnih, sigurnih i automatizovanih sistema.<br/><br/>Moje primarne oblasti su rad sa DevOps tehnologijama i alatima, razvoj alata unutar myVestaCP panela, i administracija VPS i dedicated servera. Svoj rad temeljim na efikasnosti, sigurnosti i potpunom razumevanju sistema koje održavam.<br/><br/>U slobodno vreme se posvećujem razvoju sopstvenih projekata, učenju JavaScripta i frontend tehnologija.<br/><br/>Kompetencije&#58; Linux administracija, Bash scripting, WordPress multisite, MyVestaCP, DNS, PHP, DevOps alati<br/>');

    $("#Terminal").append('<br/>experience &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Prethodna zaposlenja i projekti<br/>');
    $("#Terminal").append('education &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; - &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Obrazovanje i sertifikati<br/>');
}
//experience
else if (CurrentCommand == 'experience' || CurrentCommand == 'jobs') {
    $("#Terminal").append('Osnivač i administrator u <img src="https://pcx3.com/slike/mega.png" height="16px"> Stellar Technologies<br/><br/>');
    $("#Terminal").append('2022 - trenutno<br/>');
    $("#Terminal").append('<i class="fa fa-map-marker"></i> Srbija (remote global)<br/><br/>');
    $("#Terminal").append('Pružam upravljanje VPS-ovima i hostovanim sistemima zasnovanim na MyVestaCP panelu. Fokusiram se na sigurnost, dostupnost i automatizaciju kako bih klijentima omogućio pouzdan i brz hosting.<br/><br/>');
    $("#Terminal").append('<hr/><br/>');

    $("#Terminal").append('Freelance sistem administrator i DevOps konsultant<br/><br/>');
    $("#Terminal").append('2018 - 2022<br/>');
    $("#Terminal").append('<i class="fa fa-map-marker"></i> Remote<br/><br/>');
    $("#Terminal").append('Radio sam na migracijama, optimizaciji i održavanju sistema baziranih na Linux-u, sa fokusom na Debian ekosistemu i rešavanje kompleksnih problema sa serverima.<br/>');
}
//education
else if (CurrentCommand == 'education' || CurrentCommand == 'certificates') {
    $("#Terminal").append('Ekonomski fakultet Univerziteta u Beogradu<br/><br/>');

    $("#Terminal").append('<hr/>myVesta & Linux prakse<br/>');
    $("#Terminal").append('<img src="/images/favicon.ico" width="16px"></img> Rad na myVestaCP repou i kreiranje prilagođenih v- komandi<br/>');
    $("#Terminal").append('<img src="/images/favicon.ico" width="16px"></img> Automatizacija kroz Bash i cron skripte za održavanje servera<br/>');

    $("#Terminal").append('<hr/>Frontend Dev kurs (u toku)<br/>');
    $("#Terminal").append('<img src="/images/favicon.ico" width="16px"></img> HTML, CSS, JavaScript, React, Redux<br/>');
    $("#Terminal").append('<img src="/images/favicon.ico" width="16px"></img> Unit testiranje i finalni projekat u izradi<br/>');
}

    //social
    else if (CurrentCommand == 'social' || CurrentCommand == '?') {
      $("#Terminal").append('<br/>');
      $("#Terminal").append('<i class="fa fa-linkedin"></i>: <a href="https://www.linkedin.com/" target="_blank">https://www.linkedin.com</a><br/><br/>');
      $("#Terminal").append('<i class="fa fa-github"></i>: <a href="https://github.com/isscbta" target="_blank">https://github.com/isscbta</a><br/><br/>');
      $("#Terminal").append('<i class="fa fa-facebook"></i>: <a href="https://www.facebook.com/" target="_blank">https://www.facebook.com/</a><br/><br/>');
    }
    // sudo
    ...
    // resume
      ...
      $("#Terminal").append('<a href="/docs/dragan_cv.pdf" download="Dragan_CV"><u>Click here</u></a> to download my CV or type cv to open it in new window.<br/>');}
      // cv
